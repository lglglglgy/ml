...
train_path = r'/home/lgy/ml/N-MNIST/data'
test_path = r'/home/lgy/ml/N-MNIST/data'
train_mat_files = glob.glob(os.path.join(train_path, '*.mat'))
test_mat_files = glob.glob(os.path.join(test_path, '*.mat'))

# 传递 .mat 文件的路径列表给 MyDataset 类
train_dataset = MyDataset(train_mat_files, 'nmnist_r', time_window)
test_dataset = MyDataset(test_mat_files, 'nmnist_r')
# train_path = glob.glob('/home/lgy/ml/N-MNIST/data')
# test_path = glob.glob('/home/lgy/ml/N-MNIST/data')
# load datasets
